...
ACLOCAL = ${SHELL} /opt/Enigma-for-RetroFW/missing --run aclocal-1.11
ALLOCA = 
ALL_LINGUAS = de fr nl it es sv ru hu pt fi uk be el pl cs gd hr sk da
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /opt/Enigma-for-RetroFW/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/Enigma-for-RetroFW/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/Enigma-for-RetroFW/missing --run automake-1.11
AWK = gawk
...
LTLIBINTL = -lintl
LTLIBOBJS = 
MAKEINFO = ${SHELL} /opt/Enigma-for-RetroFW/missing --run makeinfo
...
SDL_CONFIG = /opt/buildroot/output/host/usr/mipsel-buildroot-linux-uclibc/sysroot/usr/bin/sdl-config
...
abs_builddir = /opt/Enigma-for-RetroFW
abs_srcdir = /opt/Enigma-for-RetroFW
abs_top_builddir = /opt/Enigma-for-RetroFW
abs_top_srcdir = /opt/Enigma-for-RetroFW
ac_ct_CC = 
ac_ct_CXX = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /opt/Enigma-for-RetroFW/install-sh
